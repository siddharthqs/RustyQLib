...
fn main() {
    ...
    for strike in [90.0, 100.0, 110.0] {
        ...
        println!(
            "{:<34} {expected:>12.6}  <- Black-Scholes target at the quoted smile vol",
            ""
        );
    }
